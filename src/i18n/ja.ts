...
export const ja: Record<TranslationKey, string> = {
  ...
  'sq.holdingOn': 'しがみつきすぎ？',
  'sq.takeRisk': 'リスクを取るべき？',
  'sq.wastingPotential': '才能を無駄にしてる？',
  'sq.rightMove': 'これは正しい選択？',
  'sq.wrongBet': 'これは間違った賭け？',
  'sq.investNow': '今投資すべき？',
  'sq.payOff': '報われる？',
  'sq.sayFeel': '気持ちを伝えるべき？',
  'sq.tellTruth': '真実を話す時？',
  'sq.willUnderstand': '理解してもらえる？',
  'sq.deceived': '騙されている？',
  'sq.fightWorth': 'この争いに価値はある？',
  'sq.standGround': '譲らないべき？',
  'sq.isItTime': '今がその時？',
  'sq.waitLonger': 'もっと待つべき？',
  'sq.willPass': 'これは過ぎ去る？',
  'sq.restOrPush': '休むべき？それとも進むべき？',
  'sq.bodyTelling': '体が何か伝えている？',
  'sq.canTrust': '信じていい？',
  'sq.friendshipSurvive': 'この友情は続く？',
  'sq.takeLeap': '飛び込むべき？',
  'sq.rightPath': 'これは正しい道？',
  'sq.makingMistake': '間違いを犯している？',
  'sq.startNew': '新しいことを始めるべき？',
  'sq.inspirationNear': 'インスピレーションは近い？',
  'sq.creativeEnergy': '今使える創造力は？',
  'sq.trustGut': '直感を信じるべき？',
  'sq.notSeeing': '見えていないものは？',
  'sq.universeSign': '宇宙からのサインがある？',
  'sq.focusToday': '今日集中すべきエネルギーは？',
  'sq.blockingLove': '恋愛を阻んでいるものは？',
  'sq.approachCareer': 'キャリアにどう向き合うべき？',
  'sq.financialEnergy': '金運はどう見える？',
  'sq.improveHealth': '今日の健康改善法は？',
  'sq.needToKnow': '今知るべきことは？',
  'sq.myCharm': '私の魅力は？',
  'sq.attractivePoints': '私の魅力的な点は？',
  'sq.whatJob': 'どんな仕事が向いている？',
  'sq.spiritualGift': '私のスピリチュアルな才能は？',
  'sq.placesHome': '居心地のいい場所は？',
  'sq.hiddenStrength': '私の隠れた強みは？',
  'sq.drawnTo': '惹かれる人のタイプは？',
  'sq.creativitySource': '創造力の源は？',
  'sq.focusWeek': '今週集中すべきことは？',
